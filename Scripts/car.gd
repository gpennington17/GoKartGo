...
func _ready():
	...
	get_node("CollisionShape2D").connect("body_enter",self,"_on_StaticBody2D_body_enter")
	get_node("CollisionShape2D").connect("body_exit",self,"_on_StaticBody2D_body_exit")
